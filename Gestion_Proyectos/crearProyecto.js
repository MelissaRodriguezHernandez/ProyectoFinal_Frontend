...
function crearFase(){
    ...
    http.open("POST","http://localhost:8080/Gestion_Proyectos/CrearFaseSRVLT",true);
    http.setRequestHeader("Content-type","application/x-www-form-urlencoded");
    http.send("nombre="+document.getElementById('nombre_fase').value+"&&descripcion="+document.getElementById('descripcion_fase').value+"&&importancia="+document.getElementById('importancia_fase').value+"&&fechaI="+document.getElementById('fecha_inicio_fase').value+"&&fechaF="+document.getElementById('fehca_final_fase').value);
}
